...
def makeWebBanner(product, texts, size, purposes):
    ...
    webBannerImage.save("webBannerImage.png")
    # direction = 'right'
    image, changed_texts, position, font_size, kerning, alignments = textOnImage(webBannerImage, texts, size, purposes, direction)
    image.save("webBannerImage_최종.png")
    # direction = 'right'
    return image, changed_texts, position, font_size, kerning, alignments
